							...
							where tanggal_disetujui is null and status_siswa is null");
						...
						<tr class="gradeU">
						    ...
						    <td class="center">
		                                       <a href="ppdb_insert.php?id=<?=$d['id_siswa_baru'];?>"><button type="button" class="btn btn-success btn-xs">Proses</button></a>
						    </td>
                                                </tr>
						<?php
						}
